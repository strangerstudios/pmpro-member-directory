...
export default registerBlockType(
    'pmpro-member-directory/directory',
    {
        ...
        edit: props => {
          const { attributes:  { show_avatar, avatar_size, fields, levels, show_email, show_level, show_search, show_startdate, show_map, map_zoom, map_height, map_width, map_max_zoom, map_infowindow_width, layout, limit, link, order, order_by },
