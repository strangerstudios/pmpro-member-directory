        ...
        return (
            <div>
                <div className="col4">                
                    ...
                    <span style={{fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '10px'}}>{ dummy_data[0].name }</span><br/>
                ...
                <div className="col4">                
                    ...
                    <span style={{fontSize: '1.2rem', fontWeight: 'bold'}}>{ dummy_data[2].name }</span><br/>
                ...
                <div className="col4">                
                    ...
                    <span style={{fontSize: '1.2rem', fontWeight: 'bold'}}>{ dummy_data[3].name }</span><br/>
